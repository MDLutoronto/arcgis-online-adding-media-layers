...
[Repositioning Media](#repositioning-media)  
[Overlay Manipulation of an Image](#overlay-manipulation-of-an-image)  
[Side-by-side Manipulation of an Image](#side-by-side-manipulation-of-an-image)  
[Using the Layer](#using-the-layers)  
[Saving](#saving)
...
Technique: [Georeferencing](https://mdl.library.utoronto.ca/technique/georeferencing) | Tools: [ArcGIS Online](https://mdl.library.utoronto.ca/taxonomy/term/69) | Data Format: [Raster](https://mdl.library.utoronto.ca/data-format/raster)
